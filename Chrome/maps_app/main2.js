// ==UserScript==
// @name          IMDbjelizer
// @description	  Cria um botao para pesquisa no imdb
// @match       http://www.bj2.me/detalhes.php?id=*
// @match       http://www.bj2.me/pesquisa_videos.php?*
...
window.gm_show_menu = function(e, t, x, y, isSame) {
  ...
  if (!isSame || !document.getElementById('GmMenu')) {
    ...
    for (var k in s) {
     ...
     l['imdb']['<img src="http://img.bj2.me/files/1208uun127.png" class="imgb2" alt="Pesquisar no IMDb">'] = 'http://imdb.pt/find?s=all&q=';

     l['youtube']['<img src="http://img.bj2.me/files/1208wun742.png" alt="Pesquisar no Youtube">'] = 'http://www.youtube.com/results?search_query='; 
	 
	 l['filmow']['<br/><img src="http://img.bj2.me/files/1208wsr239.png" width="90px" class="filmow" alt="Pesquisar no filmow">'] = 'http://filmow.com/buscar/?q=';

    html = '<style>.menLink, div.menLink a {color: #125298; text-align: left; padding: 0; margin: 0; font-size: 1px; display: inline;} .imgb {float: right; padding:0 !important;} #gm_menu_link_Bootleg a{display: block !important; color: #125298 !important;} .imgb2 {margin-left: 5px;} .filmow { padding: 0 0 0 25px; } hr {width: 90%;}</style>\n<center>\n Bj-Linkfy <a href="javascript:void(document.getElementById(\'GmMenu\').style.display=\'none\')" class="menLink"><img src="http://wordchaos.com/create/close_button.gif" class="imgb"></a></center>\n<hr>\n'; 
  ...
  if (document.getElementById('GmMenu')) {
    ...
    div.setAttribute('style', 'position: absolute; z-Index: 999; width: 155px; background: #125298; border: #333 solid 2px;/*-webkit-opacity: 0.8; -moz-opacity: 0.8;*/ margin: 2px; color: #FFF; font-size: 12px; padding: 5px; -webkit-box-shadow: 3px 3px #a6a5a5;');
    div.innerHTML = html;
