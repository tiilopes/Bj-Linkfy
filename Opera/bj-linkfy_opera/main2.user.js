...
window.gm_show_menu = function(e, t, x, y, isSame) {
  ...
  if (document.getElementById('GmMenu')) {
    ...
    div.setAttribute('style', 'position: absolute; z-Index: 999; width: 155px; background: #125298; border: #333 solid 2px;/*-webkit-opacity: 0.8; -moz-opacity: 0.8;*/ margin: 2px; color: #FFF; font-size: 12px; padding: 5px; -webkit-box-shadow: 3px 3px #a6a5a5; box-shadow: 3px 3px #a6a5a5;o-box-shadow: 3px 3px #a6a5a5;opacity: 0.8;');
    div.innerHTML = html;
